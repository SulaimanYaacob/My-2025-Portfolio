    ...
    <header className="bg-purple-700">
      ...
      >
        <div className="flex flex-1 items-center justify-between">
          ...
          <button className="text-md rounded-sm border-b-4 border-r-4 border-purple-400 border-r-purple-500 bg-purple-100 px-4 py-1 font-semibold text-purple-700 shadow-md hover:bg-purple-50 active:border-none md:block">
            Login
          </button>
        </div>
